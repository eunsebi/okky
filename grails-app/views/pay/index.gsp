...
<head>
    ...
    <asset:stylesheet src="pay/jui/jui.min.css"/>
    <asset:stylesheet src="pay/lib/animate.min.css"/>
    <asset:stylesheet src="pay/lib/main.css"/>
    <asset:stylesheet src="pay/fullcalendar/fullcalendar.css"/>
    <asset:stylesheet src="pay/fullcalendar/fullcalendar.print.css"/>
    <asset:javascript src="pay/SE/js/HuskyEZCreator.js" />
    <asset:javascript src="pay/lib/jquery.min.js" />
    <asset:javascript src="pay/lib/jquery-ui.custom.min.js" />
    <asset:javascript src="pay/fullcalendar/fullcalendar.min.js" />
    <asset:javascript src="pay/lib/niee-canvas-chart003.js" />
    <asset:javascript src="pay/lib/ajaxfileupload.js" />
    <asset:javascript src="pay/js/base.js" />
    <asset:javascript src="pay/js/core.js" />
    <asset:javascript src="pay/js/ui/button.js" />
    <asset:javascript src="pay/js/ui/combo.js" />
    <asset:javascript src="pay/js/ui/datepicker.js" />
    <asset:javascript src="pay/js/ui/dropdown.js" />
    <asset:javascript src="pay/js/ui/modal.js" />
    <asset:javascript src="pay/js/uix/table.js" />
    <asset:javascript src="pay/js/uix/tree.js" />
</head>
...
<div class="jui" style="width: 1250px;margin: 0 auto;">
        ...
        <div class="body">
            <table border="0">
                <tr>
                    ...
                    <td>근무시간 :</td>
                    <td>
                        <input id="job_time_Update" name="job_time_Update" type="text" value="240" size="10" maxlength="10"/>
                    </td>
                </tr>
                <tr>
                    <td>만근수당 :</td>
                ...
                <tr>
                    ...
                    <td>등록월  :</td>
                    <td>
                        <input id="pay_date_Update" name="pay_date_Update" type="text" size="10" maxlength="10" readonly/>
                    </td>
                </tr>

                <tr>
                    <td height="20" colspan="2">&nbsp;</td>
                    <td height="20">ex)201801</td>
                </tr>
            </table>
            <div style="text-align: center;">
                <a href="#" id="payBtn_Update" class="btn btn-gray btn-small">저장</a>
                <a href="#" id="payClose_Update" class="btn btn-gray btn-small">Close</a>
            </div>
        </div>
    </div>
    <!-- schedule view modal -->
        ...
        <div class="body">
            <table border="0">
                ...
                <tr>
                    ...
                    <td>등록월  :</td>
                    <td>
                        <input id="pay_date" name="pay_date" type="text" size="10" maxlength="10"/>
                    </td>
                </tr>
        ...
        <div class="body">
            ...
            <div id="main_View" style="display: block;">
                <div class="group">
                    ...
                    <a class="left btn btn-mini btn-gray-black" id="etc-game"><span>시급수정</span>&nbsp;<i class="icon-add-dir"></i></a>
                ...
                <table border="0">
                    <td valign="top">
                        <div id="pay-contents" style="margin-top: 5px;"></div>
                    </td>
                    <td width="30">&nbsp;</td>
                    <td>
    ...
    <asset:javascript src="pay/intranet_JUI.js" />
    <asset:javascript src="pay/intranet_JQUERY.js" />
    <asset:javascript src="pay/intranet_FUNCTION.js" />
    <asset:javascript src="pay/intranet_DATE.js" />
</body>
</html>